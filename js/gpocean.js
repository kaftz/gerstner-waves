class Wave {
  // lambda in meters
  // phase in radians
  constructor(k, lambda, pAmp, phase) {
...
class Ocean {
  constructor(options) {
    ...
    for (var m = 0; m < this.vertexRows; m++) {
      for (var n = 0; n < this.vertexCols; n++) {
        ...
        normalsArray.push(0, 1, 0); // TODO: Init required?
  ...
  evaluate(t) {
    ...
    if (this.options.computeNormalMesh) {
      // TODO: Remove, do this in loop
      this.normalVertices.set(this.vertices);
